This bundle contains data that can be used to try CampaignChain or to demo it
to potential users. Learn how to use it at http://doc.campaignchain.com/en/master/open/developer/book/sample_data.html.
